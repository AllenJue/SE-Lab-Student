...
/**************************************************************
 * Please note that mem, reg, cc, and status are important
 * variables you'll use in different stages. 
 * I would group them with the rest of the important variables,
 * but they're used in other functions in the simulator so it
 * won't compile without a lot of extra changes.
 * 
 * The rest of the important global variables are declared on
 * lines 273-308.
 * ************************************************************/
